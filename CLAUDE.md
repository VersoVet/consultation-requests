# consultation-requests - Guide de Développement Forge

> **FICHIER GÉNÉRÉ PAR FORGE - NE JAMAIS MODIFIER**
> En cas de modification, régénérer avec: `forge regenerate-claude consultation-requests`
> Ou via API: POST /api/skills/consultation-requests/regenerate-claude
...
**IMPORTANT**: Votre code sera automatiquement validé par `curl -X POST http://10.0.0.13:4080/api/validate/consultation-requests`
...
☐ curl -X POST http://10.0.0.13:4080/api/validate/consultation-requests = valid: true
